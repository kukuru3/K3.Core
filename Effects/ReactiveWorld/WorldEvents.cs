...
namespace K3.ReactiveWorld {
    ...
    /// </summary>
    //public class GameEvents : IExecutesTeardown {
    //    List<IGameEventEmitter> emitters = new List<IGameEventEmitter>();
    //    List<IGameEventObserver> observers = new List<IGameEventObserver>();

    //    public GameEvents() {
    //        K3ContextUtilities.Context.UnityEventSource.OnScriptCreated += HandleScriptCreated; 
    //        K3ContextUtilities.Context.UnityEventSource.OnScriptDestroyed += HandleScriptDestroyed;
    //    }
